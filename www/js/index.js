...
/*funciones de coneccion con el servidor*/
var ajx = 
{
	server: 'http://prosiddemexico.alwaysdata.net',
...
var app = 
{
	...
	bindEvents: function() 
	{
        ...
        takePhoto.addEventListener('click', app.take_image, false);
...
/*obtiene productos del servidor y los muestra*/
	...
	{
		var datos = {'operacion':'prodcutos'};
		ajx.enviar_peticion(app.ini_productos, "", "/files/descripcion_productos.xml", datos);
	},
	...
	take_image: function(){
		navigator.camera.getPicture(Imagen.onPhotoDataSuccess, app.onFail,  { quality: 20,
...
var qr = 
{
	...
	leer_qr: function ()
	{
		...
		(
			function (result)
			{
				datos = {'id_analisis': result.text};
				ajx.enviar_peticion(qr.get_datos, "", "/appmovil.php", datos);
	              	},
